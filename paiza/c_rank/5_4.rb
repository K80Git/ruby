...
team_member = gets.split(" ")

a_team = team_member[0].to_i
b_team = team_member[1].to_i
...
for i in 1..b_team
  num = gets.split(" ")
  b_team_task.push(num)
end

a_team_task.each do |a_per|
  b_team_task.each do |b_per|
    if a_per[1].to_i == b_per[0].to_i
      puts "#{a_per[0].to_i} #{b_per[1].to_i}"
    end
  end
end
